...
class NaturalListTest {
    ...
    @Test
    fun notEqualsToOtherListWithSameValuesInDifferentOrder() {
        assertNotEquals(
            listOf(5, 4, 3, 2, 1),
            NaturalList(5)
        )
    ...
    fun generatesHashCode() {
        assertNotEquals(0, NaturalList(5).hashCode())
        assertNotEquals(NaturalList(5).hashCode(), NaturalList(50).hashCode())
    }
}